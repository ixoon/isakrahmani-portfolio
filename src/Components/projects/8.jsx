    ...
    return (
      ...
      <Carousel id="carouselExampleInterval" className={styles.carousel} interval={10000}>
        <Carousel.Item className={styles.carouselItem}>
          <img src={delivery} className={styles.carouselImage} alt="Slide 1" />
        </Carousel.Item>
      </Carousel>
    </div>
      <div>
        <h1 className={styles.header}>Delivery app</h1>
        <p className={styles.description}>Delivery app built in HTML, CSS, JavaScript and React!</p>
      </div>
