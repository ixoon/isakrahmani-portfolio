...
import weather from '../home/images/weather-3.jpg';
import weather2 from '../home//images/weather-2.jpg';
import weather3 from '../home/images/dragas.jpg';
    ...
    return (
      ...
      <Carousel id="carouselExampleInterval" className={styles.carousel} interval={10000}>
        <Carousel.Item className={styles.carouselItem}>
          <img src={weather} className={styles.carouselImage} alt="Slide 1" />
        </Carousel.Item>
        <Carousel.Item interval={2000} className={styles.carouselItem}>
          <img src={weather2} className={styles.carouselImage} alt="Slide 2" />
        </Carousel.Item>
        <Carousel.Item className={styles.carouselItem}>
          <img src={weather3} className={styles.carouselImage} alt="Slide 3" />
        </Carousel.Item>
      </Carousel>
    </div>
      <div>
        <h1 className={styles.header}>Weather app</h1>
        <p className={styles.description}>Weather app built in HTML, CSS, JavaScript and React!</p>
      </div>
