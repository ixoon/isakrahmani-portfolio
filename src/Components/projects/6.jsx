...
import comment1 from '../home/images/comments1.jpg';
import comment2 from '../home/images/comments2.jpg';
import comment3 from '../home/images/comments3.jpg';
    ...
    return (
      ...
      <Carousel id="carouselExampleInterval" className={styles.carousel} interval={10000}>
        <Carousel.Item className={styles.carouselItem}>
          <img src={comment1} className={styles.carouselImage} alt="Slide 1" />
        </Carousel.Item>
        <Carousel.Item interval={2000} className={styles.carouselItem}>
          <img src={comment2} className={styles.carouselImage} alt="Slide 2" />
        </Carousel.Item>
        <Carousel.Item className={styles.carouselItem}>
          <img src={comment3} className={styles.carouselImage} alt="Slide 3" />
        </Carousel.Item>
      </Carousel>
    </div>
      <div>
        <h1 className={styles.header}>Comment app</h1>
        <p className={styles.description}>Comment app built in HTML, CSS, JavaScript and React!</p>
      </div>
