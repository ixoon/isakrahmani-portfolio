...
import rock1 from '../home/images/rock-win.jpg';
import rock2 from '../home/images/rock-lose.jpg';
    ...
    return (
      ...
      <Carousel id="carouselExampleInterval" className={styles.carousel} interval={10000}>
        <Carousel.Item className={styles.carouselItem}>
          <img src={rock1} className={styles.carouselImage} alt="Slide 1" />
        </Carousel.Item>
        <Carousel.Item interval={2000} className={styles.carouselItem}>
          <img src={rock2} className={styles.carouselImage} alt="Slide 2" />
        </Carousel.Item>
      </Carousel>
    </div>
      <div>
        <h1 className={styles.header}>Rock-paper-scissors app</h1>
        <p className={styles.description}>Rock-paper-scissors built in HTML, CSS, JavaScript and React!</p>
      </div>
